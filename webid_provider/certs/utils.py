...
class CertCreator(object):
    ...
    def _get_cert_configs(self, **kwargs):
        from webid_provider.models import CertConfig
    ...
    def _get_user_data(self, user):
        from webid_provider.models import WebIDUser
    ...
    def _save_pubkey_instance(self):
        from webid_provider.models import PubKey
    ...
    def _save_cert_instance(self):
        from webid_provider.models import Cert
        c = Cert()
        c.fingerprint_sha1, \
        c.fingerprint_md5,\
